...
-   Do different types of food show different relationships between
    nutrients and caloric value?
...
<!-- Linear regression: $y = X\beta + \varepsilon, \quad \varepsilon \sim N(0,\sigma^2 I)$ -->

<!-- Likelihood: $p(y \mid \beta,\sigma^2) \propto \exp\left(-\frac{1}{2\sigma^2}\|y - X\beta\|^2\right)$ -->
